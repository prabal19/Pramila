        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center justify-end gap-2 md:gap-3">
              <Button asChild variant="ghost" size="icon" className="hidden md:inline-flex" aria-label="Visit our Instagram">
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer">
                  <InstagramIcon />
                </a>
              </Button>
              <Button asChild variant="ghost" size="icon" aria-label={user ? 'My Account' : 'Login'}>
              ...
              <Button id="cart-sheet-trigger" variant="ghost" size="icon" className="relative" onClick={handleCartClick} aria-label={`Open cart, ${cartCount} items`}>
