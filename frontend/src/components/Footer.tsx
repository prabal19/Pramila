             ...
             <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="flex items-center gap-x-6">
                    <div className="flex items-center gap-x-4 text-gray-500">
                     <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hover:text-black transition-colors"><InstagramIcon /></a>
                 ...
                 <div className="text-xs text-gray-500 order-none">
